  ...
  @media screen and (max-width: 400px) {
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a href="../carwash/viewwash1.php">view appointment list</a>
             <a href="../carwash/viewwash2.php">view cars for appointment </a>
            <a href="reportapp.php">Get Report</a>
      ...
      <div class="img">
        <center>
      <img src="app.jpeg" height="50%" width="50%">
