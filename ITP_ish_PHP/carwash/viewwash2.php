...
.sidebar {
  ...
  @media screen and (max-width: 400px) {
    ...
    <body>
        ...
        <center><h1>CARWASH VEHICLE LIST</h1></center><br>
      ...
      <div class="well">
		...
		<tr>
			...
			<td> <?php echo $cnum?> </td>
						...
						<td> <a href="edit.php?GETID=<?php echo $vehID ?>"> EDIT </a> </td>
			<td> <a href="deletewash2.php?delete=<?php echo $vehID ?>"> DELETE </a> </td>
		</tr>
